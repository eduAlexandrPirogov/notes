...
Распишу один большой пример, где, как мне кажется, удачно использовал абстракцию и технику "поднять-решить-принизить" до прочтения материала. Думаю, это будет интересно.
...
message-passing с помощью каналов. Тогда, как мне сейчас уже видется, плохое отражение watcher можно заменить на message-passing -- ведь в зависимости от переданной ошибки
по каналу, можно выполнить соответствующее действие.
